...
COPY Biro.BaaS.v3/src/Blocks/Biro.Blocks.Debit/Biro.Blocks.Debit.csproj ./src/Blocks/Biro.Blocks.Debit/
...
RUN dotnet restore ./src/Blocks/Biro.Blocks.Debit/Biro.Blocks.Debit.csproj

# Copy the rest of the project files and build the application
COPY Biro.BaaS.v3/src/Blocks/Biro.Blocks.Debit/. ./src/Blocks/Biro.Blocks.Debit/
...
RUN dotnet publish -c Release -o out ./src/Blocks/Biro.Blocks.Debit/Biro.Blocks.Debit.csproj

# Use the official ASP.NET runtime image to run the application
FROM mcr.microsoft.com/dotnet/aspnet:8.0 AS runtime
WORKDIR /app
COPY --from=build /app/out .
ENTRYPOINT ["dotnet", "Biro.Blocks.Debit.dll"]
