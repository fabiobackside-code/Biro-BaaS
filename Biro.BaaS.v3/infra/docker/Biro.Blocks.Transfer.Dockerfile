...
COPY Biro.BaaS.v3/src/Blocks/Biro.Blocks.Transfer/Biro.Blocks.Transfer.csproj ./src/Blocks/Biro.Blocks.Transfer/
...
RUN dotnet restore ./src/Blocks/Biro.Blocks.Transfer/Biro.Blocks.Transfer.csproj

# Copy the rest of the project files and build the application
COPY Biro.BaaS.v3/src/Blocks/Biro.Blocks.Transfer/. ./src/Blocks/Biro.Blocks.Transfer/
...
RUN dotnet publish -c Release -o out ./src/Blocks/Biro.Blocks.Transfer/Biro.Blocks.Transfer.csproj

# Use the official ASP.NET runtime image to run the application
FROM mcr.microsoft.com/dotnet/aspnet:8.0 AS runtime
WORKDIR /app
COPY --from=build /app/out .
ENTRYPOINT ["dotnet", "Biro.Blocks.Transfer.dll"]
