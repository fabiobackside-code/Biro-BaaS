...
COPY Biro.BaaS.v3/src/Blocks/Biro.Blocks.Balance/Biro.Blocks.Balance.csproj ./src/Blocks/Biro.Blocks.Balance/
...
RUN dotnet restore ./src/Blocks/Biro.Blocks.Balance/Biro.Blocks.Balance.csproj

# Copy the rest of the project files and build the application
COPY Biro.BaaS.v3/src/Blocks/Biro.Blocks.Balance/. ./src/Blocks/Biro.Blocks.Balance/
...
RUN dotnet publish -c Release -o out ./src/Blocks/Biro.Blocks.Balance/Biro.Blocks.Balance.csproj

# Use the official ASP.NET runtime image to run the application
FROM mcr.microsoft.com/dotnet/aspnet:8.0 AS runtime
WORKDIR /app
COPY --from=build /app/out .
ENTRYPOINT ["dotnet", "Biro.Blocks.Balance.dll"]
